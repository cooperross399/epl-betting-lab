...
|:------|:-------|:----------|:-----|-----:|------:|:-----|------:|
| Newcastle v Bournemouth | `corners_1x2` | home | C | +6.6% | -139 | BetRivers | 0.1 |
...
| Brighton v Leeds | `corners_total_10_5` | under | C | +4.7% | -136 | FanDuel | 0.1 |
| Newcastle v Bournemouth | `draw_no_bet` | home | C | +4.6% | -150 | Caesars | 0.1 |
