...
|:------|:-------|:----------|:-----|-----:|------:|:-----|------:|
| Bournemouth v Brentford | `draw_no_bet` | away | C | +7.1% | -102 | BetOnline.ag | 0.1 |
| Chelsea v Hull | `btts` | yes | C | +6.6% | -106 | Caesars | 0.1 |
| Coventry v Brighton | `corners_1x2` | home | C | +6.5% | +175 | FanDuel | 0.1 |
...
| Liverpool v Fulham | `double_chance` | draw_or_away | C | +5.6% | +185 | BetOnline.ag | 0.1 |
...
- **Added:** Aston Villa v Nott'm Forest corners_total_10_5 over
